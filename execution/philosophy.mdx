...
description: "Why a Dequan trade lands while other tools are still building the transaction."
icon: "bolt"
---
...
It is not magic. It is not "we have a secret RPC." It is a careful, end-to-end pipeline where every step has been optimised by people who care about milliseconds.

It is also not invisible. Every Dequan trade is logged with full per-stage latency you can inspect afterward in the [Latency Transparency](/reliability/latency-transparency) panel. We don't ask you to trust the speed — we let you see it.
