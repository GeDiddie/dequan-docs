---
title: "Timings - Latency Transparency"
icon: "stopwatch"
---

Anyone can claim "fastest." Few platforms let you check.

Dequan records the timing of every stage of every trade you make — quote, build, sign, broadcast, confirmation — and surfaces it in the **Timings** card inside the detailed view of each trade in your Portfolio. You can audit it at any time.
...
<Card title="Signing latency" icon="signature">
  The signing step. On Lightning Wallet, this is server-side and very fast. On main-wallet signing, this includes the user's confirmation time (which is mostly *you*, not us).
</Card>
